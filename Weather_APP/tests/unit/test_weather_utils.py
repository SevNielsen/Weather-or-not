...
from website.weather_utils import weekday_from_date, fetch_coordinates, fetch_map_data, fetch_current_weather_data
...
def test_fetch_weather_data_success(mock_requests, mock_env):
    ...
    weather_response, forecast_response = fetch_current_weather_data(city)
